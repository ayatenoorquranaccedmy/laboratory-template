  ...
  return (
    <div className="bg-white p-8 md:p-2 rounded-lg print:rounded-none shadow-lg print:shadow-none border print:border-none report-page relative min-h-screen">
      ...
      <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden">
        <div className="opacity-[0.03] print:opacity-[0.05] w-[800px] h-[800px] relative">
          <Image
            src="/logo1.png"
            alt="Watermark"
            fill
      ...
      <div className="relative z-10">
        ...
        <div className="report-body">
          ...
          <div className="mb-4 print:mb-3">
            <h2 className="text-lg font-bold text-green-700 mb-3 pb-2  border-green-300 print:text-base print:mb-2 print:pb-1">
              Patient Information
            </h2>
          ...
          {categories.length > 0 ? (
            <div className="mb-6 print:mb-4">
              ...
              <h2 className="text-lg font-bold text-green-700 mb-4 pb-2  border-green-300 print:text-base print:mb-3 print:pb-1">
                TEST RESULTS
              </h2>
